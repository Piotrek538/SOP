  ...
  <section class="bg-white position-relative d-flex flex-column align-items-center justify-content-center h-100">
    ...
    <div class="w-100 container-xxl">
      <div class="mt-5 w-100">
        <section class="my-5 mb-7rem px-lg-5 w-100" v-if="patients?.length && patients">
            ...
            <div class="w-100 py-1 p-lg-3">
              <div class="w-100 d-flex flex-column flex-lg-row p-2 gap-lg-5 justify-content-center align-items-center">
                <div class="w-100 my-2">
                  <div class="w-100 d-flex flex-row p-2 justify-content-center align-items-center" style="gap:0.6rem">
                    ...
                    <p class="m-0" style="color:#626466 font-weight:600">Imię</p>


                  </div>
                  <div style="font-weight:600" class="p-2 w-100 patient-name">{{ convertFirstName(patient.firstName) }}
                  </div>
                </div>
                ...
                <div class="w-100 my-2">
                  <div class="w-100 d-flex flex-row p-2 justify-content-center align-items-center" style="gap:0.6rem">
                    ...
                    <p class="m-0" style="color:#626466 font-weight:600">Nazwisko</p>
                  </div>
                  <div style="font-weight:600" class="p-2 w-100 patient-name">{{ convertLastName(patient.lastName) }}
                  </div>
                ...
                <div class="w-100 my-2">
                  <div class="w-100 d-flex flex-row p-2 justify-content-center align-items-center" style="gap:0.6rem">
                    ...
                    <p class="m-0" style="color:#626466 font-weight:600">Pesel</p>
                  </div>
                ...
                <div class="w-100 my-2">
                  ...
                  <div style="font-weight:600" class="p-2 w-100 patient-name">{{ convertDate(patient.birthDate) }}</div>
                ...
                <div class="w-100 my-2">
                  <div class="w-100 d-flex flex-row p-2 justify-content-center align-items-center" style="gap:0.6rem">
                    ...
                    <p class="m-0" style="color:#626466 font-weight:600">Płeć</p>
                  </div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      axios.get('https://patient-service-api.herokuapp.com/patient/archived/all')
        .then(response => {
    ...
    computed: {
      filteredList() {
        return this.patients.filter(patient => {
          return (this.convertFirstName(patient.firstName) + " " + this.convertLastName(patient.lastName) + " " +
            this.convertPESEL(patient.pesel) + " " + this.convertDate(patient.birthDate) + " " + this
            .convertGender(patient.gender) + " " + patient.age).toLowerCase().includes(this.search.toLowerCase())
        })
      }
    }
  }
